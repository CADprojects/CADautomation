...
public class TrafficSourcesPage extends PageBase {
    ...
    public void addNewSourceValue() {
        ...
        WaitersUtils.getWaiter(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(SUCCESSFULTRAFFICSOURCEADDNOTIF));
        WaitersUtils.getWaiter(driver, 30).until(ExpectedConditions.invisibilityOfElementLocated(SUCCESSFULTRAFFICSOURCEADDNOTIF));
    }
    ...
    public void deleteSpecifiedSourceValue() {
        ...
        WaitersUtils.getWaiter(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(SUCCESSFULTRAFFICSOURCEREMOVENOTIF));
        WaitersUtils.getWaiter(driver, 30).until(ExpectedConditions.invisibilityOfElementLocated(SUCCESSFULTRAFFICSOURCEREMOVENOTIF));
    }
