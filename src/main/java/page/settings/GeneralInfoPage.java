...
public class GeneralInfoPage extends PageBase {
    ...
    public void changeEmail() {
        ...
        WaitersUtils.getWaiter().until(ExpectedConditions.visibilityOfElementLocated(SUCCESSFULEMAILCHANGENOTIF));
        WaitersUtils.getWaiter().until(ExpectedConditions.invisibilityOfElementLocated(SUCCESSFULEMAILCHANGENOTIF));
    }
    ...
    public void changePassword() {
        ...
        WaitersUtils.getWaiter().until(ExpectedConditions.visibilityOfElementLocated(SUCCESSFULPASSWORDCHANGENOTIF));
        WaitersUtils.getWaiter().until(ExpectedConditions.invisibilityOfElementLocated(SUCCESSFULPASSWORDCHANGENOTIF));
    ...
    public void addRemoveAdvertiserFunctions() {
        ...
        WaitersUtils.getWaiter().until(ExpectedConditions.visibilityOfElementLocated(SUCCESSFULACCOUNTTYPECHANGENOTIF));
        WaitersUtils.getWaiter().until(ExpectedConditions.invisibilityOfElementLocated(SUCCESSFULACCOUNTTYPECHANGENOTIF));
    }
