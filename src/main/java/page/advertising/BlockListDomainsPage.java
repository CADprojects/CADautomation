...
public class BlockListDomainsPage extends PageBase {
    ...
    public void addDomain() {
        ...
        WaitersUtils.getWaiter().until(ExpectedConditions.visibilityOfElementLocated(SUCCESSFULDOMAINSADDORREMOVEALERT));
        WaitersUtils.getWaiter().until(ExpectedConditions.invisibilityOfElementLocated(SUCCESSFULDOMAINSADDORREMOVEALERT));
